...
class Bezier {
    ...
    // Funcion para calcular el coeficiente binomial (n sobre k)
    ...
    // Funcion que genera la curva de Bézier
    fun generateBezierCurve(nodos: List<Nodo>, steps: Int = 100): List<Pair<Float, Float>> {
        ...
        // t es el parametro que varía de 0 a 1
        for (step in 0..steps) {
            ...
            // Aplicamos la formula de Bézier para calcular el punto en (x, y)
